...
break
case"frame_state_change":var k=document.getElementById(s.default.frameDivId),L=m&&m.data,O=L&&L.frameState,M=a.default.getSettings()&&a.default.getSettings().enabledFeatures
o.default.publish("frame:statechange",m),"initialized"===O&&(a.default.isJWTEnabled()&&a.default.isJWTStrictMode()&&k.classList.add("fc_dn"),this.loadWidget(),M&&-1!==M.indexOf("COBROWSING")&&g.default.init({host:a.default.getHost(),locale:d.default.getProperties().locale})),"loaded"===O&&a.default.loaded(!0),"authenticated"!==O&&"not_authenticated"!==O||a.default.isJWTEnabled()&&a.default.isJWTStrictMode()&&(m.success?k.classList.remove("fc_dn"):304!==m.status&&this.unloadWidget())
break
case"widget_loaded":r.default.loaded(!0),o.default.publish("widget:loaded"),l.default.isLoaded()||l.default.init({host:m.pushDomain+"?ref="+btoa(window.location.origin),hostOrigin:i.default.url_domain(m.pushDomain),appLogoPath:m.appLogoPath}),r.default.doOpen()&&a.default.postMessage({action:"open_chat"}),a.default.postMessage({action:"widget_location",payload:{title:document.title,location:window.location.href}})
break
